...
/***/ (function(module, exports) {
	...
	new EmojiPanel(document.getElementById('example-2'), {
	  	onClick: function onClick(e) {
			const input = document.getElementById('mensajeEscribiendoAsesor');
			const inputHistory = document.getElementById('mensajeEscribiendoAsesorHistory');
			// const emoji = String.fromCodePoint(parseInt(e.unified, 16));
			var arry = e.unified.split('-');
			if (arry.length > 1 ) {
				var tmp = '\\u'+arry[0]+'\\u'+arry[1]+'';
				var resul = '[<'+e.unified+'>]';
			} else {
				var tmp  = e.unified
				var resul = '[{'+tmp+'}]';
